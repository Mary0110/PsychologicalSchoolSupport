...
{ 
        public void Register(TypeAdapterConfig config)
        {
                ...
                config.NewConfig<CreateScheduleCellCommand, ScheduleCell>()
                        .Map(dest => dest.Active, src => src.ScheduleCellDto.Active)
                        .Map(dest => dest.Day, src => src.ScheduleCellDto.Day)
                        .Map(dest => dest.Time, src => new TimeOnly(src.ScheduleCellDto.Hours, src.ScheduleCellDto.Minutes))
                        .Map(dest => dest.PsychologistId, src => src.ScheduleCellDto.PsychologistId);
